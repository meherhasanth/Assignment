...
extern syscall alarmx(uint32 timeval, void * ftn);
...
extern void   mybigloop();
extern void myhellow();
extern syscall sendx(pid32 , char *, uint16);
extern syscall receivex(pid32 *, char *, uint16);
/* in file freebuf.c */
