...
extern uint64 currstart;
extern uint64 currstop;
extern uint32 resptime(pid32);
extern uint32 totcpu(pid32);
extern void mybigloop(void);
extern void mybigloop2(void);
extern void myhellow(void);
extern int flag;
...
extern	pid32	createstx(void *, uint32, char *, uint32, ...);
