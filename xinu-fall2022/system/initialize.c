...
struct tsx_disp dyndisp[10]; /*dynamic scheduler */
 ...
 * be enabled explicitly.  The code int val=0;



turns itself into the null process
...
void	nulluser()
{	
// code to initilize the priority table
int i=0;
for(i=0;i<10;i++)
{
	int a=0;
	...
	dyndisp[i].quantum = 100-(i*10);
}
// code to initilize the mfeedqueue 
